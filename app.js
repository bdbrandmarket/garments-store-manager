...
if(!Array.isArray(employees)) employees = defaultEmployees.map(e=>({serial:e.serial,name:e.name,section:e.section,card:e.card}));
...
function openModal(){modal.classList.remove("hidden");$("newName").focus();}
function closeModal(){modal.classList.add("hidden");$("newName").value="";$("newCard").value="";$("newSection").value="Operator";}
